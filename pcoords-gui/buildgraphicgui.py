...
class Buildpanel (QtGui.QDialog):
    ...
    def defineParser (self):
        self.nameParserFile = pcvfile = QtGui.QFileDialog.getOpenFileName(None,"Open Parser File","","")
        self.ui.pathParser.setText(self.nameParserFile)

    def savePgdl (self):
        self.namePgdlFile = pgdlfile = QtGui.QFileDialog.getSaveFileName(None,"Save Parser File","/home","")
